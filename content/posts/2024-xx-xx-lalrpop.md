...
Я уже много лет работаю разработчиком и в какой-то момент много лет назад я захотел написать свой язык программирования.
...
все больше начал скланяться к функциональному стилю и применять его даже к таким языкам как Python, Rust, Go.
Относительно недавно мне захотелось заставить синтаксис что-то делать и так как я стал больше использовать Rust, решил неплохо сделать на нем плюс один язык.
Первым делом я понимал, что надо распарсить конструкции в обьекты...
